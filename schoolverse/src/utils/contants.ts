/**
 * Constants use everywhere in the projet : like routes name
 */
...
export const ROUTE_SPLASH: string = '/schoolverse';
export const ROUTE_LOADING: string = '/schoolverse-loading';
